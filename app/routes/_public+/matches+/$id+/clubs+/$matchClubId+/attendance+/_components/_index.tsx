...
export const AttendanceGroupCardContent = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("grid max-md:grid-cols-3 md:max-xl:grid-cols-2 xl:grid-cols-3 gap-2", className)}
    {...props}
  />
);
...
export const AttendanceGroupCardItem = ({
  ...
  <div
    className={cn("text-sm border px-3 py-1 rounded-lg bg-white relative text-center", className)}
    {...props}
  >
