...
import { newPasswordSchema } from "../isomorphic";
import type {
  NewPasswordInput,
  UpdatePasswordResult,
  VerifyTokenResult,
} from "../isomorphic/newPassword.types";
import * as queries from "./newPassword.queries";
...
export async function handleNewPasswordAction({ request }: ActionFunctionArgs): Promise<Response> {
  ...
  const validationResult = newPasswordSchema.NewPasswordSchema.safeParse(data);
